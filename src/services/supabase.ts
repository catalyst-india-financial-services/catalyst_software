...
const supabaseUrl = (typeof import.meta !== 'undefined' && import.meta.env?.VITE_SUPABASE_URL) || 'https://dawnjgihxnffxfvdpald.supabase.co'
const supabaseAnonKey = (typeof import.meta !== 'undefined' && import.meta.env?.VITE_SUPABASE_ANON_KEY) || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRhd25qZ2loeG5mZnhmdmRwYWxkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODU0ODg4NzQsImV4cCI6MjEwMTA2NDg3NH0.AUgUMujlmSITLoOeXgQVqe_VOsnWOsDL4GwNijEieJ8'
